...
export const ERROR_INVALIDASSIGN = "Invalid left side in assignment"
...
export const BUILTIN_DICTIONARY_NAME = "Dictionary";
export const BUILTIN_VALUE_ANON   = "anonymous";
